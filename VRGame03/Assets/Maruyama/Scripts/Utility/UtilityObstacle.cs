...
namespace maru
{
    public static class UtilityObstacle
    {
        ...
        public static bool IsRayObstacle(Vector3 startPosition, Vector3 targetPosition, float sphereRange = 0.5f)
        {
            return IsRayObstacle(startPosition, targetPosition, sphereRange, DEFAULT_RAY_OBSTACLE_LAYER_STRINGS);
        }

        public static bool IsRayObstacle(Vector3 startPosition, Vector3 targetPosition, float sphereRange = 0.5f, params string[] obstacleLayers)
        {
